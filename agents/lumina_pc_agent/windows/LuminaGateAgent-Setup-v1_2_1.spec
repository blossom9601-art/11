...
a = Analysis(
    ...
    hiddenimports=['tkinter', 'tkinter.ttk', 'servicemanager', 'pywintypes', 'win32event', 'win32service', 'win32serviceutil', 'win32timezone', 'win32crypt'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
...
exe = EXE(
    ...
    a.datas,
    [],
    name='LuminaGateAgent-Setup-v1_2_1',
    debug=False,
