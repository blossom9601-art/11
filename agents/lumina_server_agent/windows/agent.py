...
def _run_gui(config: AgentConfig):
    ...
    ctk.CTkLabel(hdr_inner, text="Lumina Server Agent", font=("Segoe UI Semibold", 17),
                 text_color="white").pack(side="left", pady=14)
    ctk.CTkLabel(hdr_inner, text=VERSION, font=("Segoe UI", 10),
