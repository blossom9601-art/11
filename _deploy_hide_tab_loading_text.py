...
_, stdout, _ = ssh.exec_command("grep -n 'work_classification_list.js?v=20260414b' /opt/blossom/web/app/templates/9.category/9-1.business/9-1-1.work_classification/1.work_classification_list.html")
print('Version marker:')
print(stdout.read().decode().strip())

_, stdout, _ = ssh.exec_command("grep -n 'colspan=.*&nbsp;' /opt/blossom/web/static/js/9.category/9-1.business/9-1-1.work_classification/1.work_classification_list.js")
print('Loading-row text removed marker:')
print(stdout.read().decode().strip())
