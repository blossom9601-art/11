...
def init_hw_frame_frontbay_table(app=None) -> None:
    app = app or current_app
...
def list_hw_frame_frontbay_items(
    scope_key: str,
    asset_id: int,
    *,
    page: int = 1,
...
def create_hw_frame_frontbay_item(payload: Dict[str, Any], *, actor: str = 'system', app=None) -> Dict[str, Any]:
...
def update_hw_frame_frontbay_item(item_id: int, payload: Dict[str, Any], *, actor: str = 'system', app=None) -> Dict[str, Any]:
...
def delete_hw_frame_frontbay_item(item_id: int, *, app=None) -> None:
    item_id = _sanitize_int(item_id)
    with _get_connection(app) as conn:
        conn.execute(
