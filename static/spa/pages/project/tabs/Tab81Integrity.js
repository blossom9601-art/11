/* ============================================================
 *  Tab81Integrity — 요구사항관리 (integrity)
 *  ============================================================
 *  API: GET/POST/PUT/DELETE /api/prj/projects/<id>/tabs/integrity
...
const COLUMNS = [
  ...
  { key: 'rqType',     label: '유형',     sortable: true },
  { key: 'code',       label: '고유번호', sortable: true, width: '100px' },
  { key: 'name',       label: '명칭',     sortable: true },
  { key: 'definition', label: '정의',     sortable: false },
  { key: 'detail',     label: '세부내용', sortable: false },
  { key: 'owner',      label: '담당자',   sortable: true, width: '100px' },
];

export default class Tab81Integrity {
  constructor({ projectId, project, tabKey, access, router }) {
    this._projectId = projectId;
    this._tabKey    = tabKey || 'integrity';
    this._access    = access;
    this._router    = router;
    this._el        = null;
    this._table     = null;
