/* ============================================================
 *  Tab90Stakeholder — 이해관계자관리 (stakeholder)
 *  ============================================================
 *  API: GET/POST/PUT/DELETE /api/prj/projects/<id>/tabs/stakeholder
...
const COLUMNS = [
  ...
  { key: 'name',        label: '이름',   sortable: true, width: '100px' },
  { key: 'nickname',    label: '별명',   sortable: true, width: '100px' },
  { key: 'role',        label: '역할',   sortable: true },
  { key: 'involvement', label: '관여도', sortable: true, width: '80px' },
  { key: 'note',        label: '비고',   sortable: false },
];

export default class Tab90Stakeholder {
  constructor({ projectId, project, tabKey, access, router }) {
    this._projectId = projectId;
    this._tabKey    = tabKey || 'stakeholder';
    this._access    = access;
    this._router    = router;
    this._el        = null;
    this._table     = null;
