(function(root){
  ...
  Modules.createHardwareSchema = function(context){
    context = context || {};
    return [{
      section: '하드웨어',
      fields: [
        { key: 'model', label: '모델명', type: 'text', required: true },
        { key: 'vendor', label: '제조사', type: 'select', required: true, searchable: true, optionsSource: 'manufacturers', preserveUnknown: true },
