...
(function(){
    ...
    async function refreshStorageData(options){
        ...
        try {
            const [vendorRes, storageRes] = await Promise.all([
            ...
            vendorCodeByName = buildVendorCodeByName(vendorRes?.items || []);
    ...
    const GROUP = { title:'스토리지', cols:['model','vendor','release_date','eosl','note'] };
