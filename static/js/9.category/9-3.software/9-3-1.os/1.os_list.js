...
(function(){
    ...
    const COLUMN_MODAL_GROUPS = [
        { group: '운영체제', columns: ['model','vendor','hw_type','release_date','eosl','qty','note'] }
    ];
    ...
    function fillEditForm(row){
        ...
        form.innerHTML='';
    const group = { title:'운영체제', cols:['model','vendor','release_date','eosl','note'] };
    ...
    const GROUP = { title:'운영체제', cols:['model','vendor','eosl','note'] };
