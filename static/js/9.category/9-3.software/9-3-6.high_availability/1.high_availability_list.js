...
(function(){
    ...
    const COLUMN_MODAL_GROUPS = [
        { group: '고가용성 유형', columns: ['model','vendor','hw_type','release_date','eosl','qty'] }
    ];
                ...
                + COLUMN_ORDER.map(col=>{
                    ...
                    if(col === 'model'){
                        ...
                        if(row.id != null && String(row.id).trim() !== ''){
                            ...
                            var params = [];
                            ['model','vendor','hw_type','release_date','eosl','qty'].forEach(function(k){
                                var v = row[k];
                                if(v == null) return;
                                var s = String(v).trim();
                                if(!s) return;
...
document.addEventListener('keydown', e=>{ if(e.key==='Escape'){ closeModal(STATS_MODAL_ID); }});
    ...
    const GROUP = { title:'고가용성 유형', cols:['model','vendor','eosl'] };
