    ...
    with app.app_context():
        ...
        with app.test_client() as client:
            ...
            res_create = client.post(
                "/api/prj/projects",
                json={
                    "project_name": f"Smoke TCO Project {stamp}",
                    "project_type": "SW",
            ...
            # 2) Create a procurement(tab79) payload that matches frontend structure
            sample_rows = [
                {
                    "method": "구매",
                    "type": "서버",
            ...
            res_post = client.post(
                f"/api/prj/projects/{project_id}/tabs/procurement",
                json={"payload": {"procurement": {"tco_rows": sample_rows}}},
            )
            ...
            res_list = client.get(f"/api/prj/projects/{project_id}/tabs/procurement")
            ...
            if payload.get("total") != 1:
                ...
                return 1
            got_rows = payload["items"][0]["payload"].get("procurement", {}).get("tco_rows")
            ...
            res_del = client.delete(f"/api/prj/projects/{project_id}/tabs/procurement/{item_id}")
            if res_del.status_code != 200:
                print("[FAIL] delete tab item", res_del.status_code, res_del.data[:500])
                return 1

            res_list2 = client.get(f"/api/prj/projects/{project_id}/tabs/procurement")
            ...
            res_list3 = client.get(f"/api/prj/projects/{project_id}/tabs/procurement?include_deleted=1")
            ...
            print("[OK] tab79(procurement/TCO) API persistence roundtrip")
